    ...
    <div class="header__top-block">
        ...
        <div class="header__social-icons header__social-icons--desktop">
            <a href="https://www.facebook.com/" aria-label="Facebook link">
                <img src="${pathTo('assets/images/header/facebook.svg')}" alt="" width="20" height="20">
            </a>
            <a href="https://x.com/" aria-label="Twitter link">
                <img src="${pathTo('assets/images/header/twitter.svg')}" alt="" width="20" height="20">
            </a>
            <a href="https://www.instagram.com/" aria-label="Instagram link">
                <img src="${pathTo('assets/images/header/instagram.svg')}" alt="" width="20" height="20">
            </a>
        </div>

        <a href="${pathTo('index.html')}" class="header__logo">
            <span class="header__logo-icon">
                <img src="${pathTo('assets/images/header/logo.png')}" alt="Logo Icon" width="35" height="35">
            </span>
        ...
        <div class="header__controls">
            <a href="#" aria-label="Account link">
                <img src="${pathTo('assets/images/header/user.svg')}" alt="" width="30" height="34">
            </a>
            <a class="header-cart" href="${pathTo('html/cart.html')}" aria-label="Shopping Cart link">
                <img src="${pathTo('assets/images/header/shopping-cart.svg')}" alt="" width="34" height="34">
    ...
    <nav class="navigation" aria-label="Navigation" id="main-navigation">
        <ul class="navigation__list">
            <li class="navigation__item" data-page="home">
                <a href="${pathTo('index.html')}">Home</a>
            </li>
            <li class="navigation__item navigation__item--has-dropdown" data-page="catalog">
                <a class="navigation__link navigation__link--with-arrow" href="${pathTo('html/catalog.html')}">
                    Catalog
                </a>
            </li>
            <li class="navigation__item" data-page="about">
                <a href="${pathTo('html/about.html')}">About Us</a>
            </li>
            <li class="navigation__item" data-page="contact">
                <a href="${pathTo('html/contact.html')}">Contact Us</a>
            </li>
        </ul>
...
<footer class="footer">
        ...
        <div class="benefits__container">
            ...
            <ul class="benefits__list">
                <li class="benefits__item">
                    <img src="${pathTo('assets/images/footer/airplane.png')}" alt="" aria-hidden="true" width="60" height="60">
                    <p>Velit nisl sodales eget donec quis, volutpat orci.</p>
                </li>
                <li class="benefits__item">
                    <img src="${pathTo('assets/images/footer/truck.png')}" alt="" aria-hidden="true" width="60" height="60">
                    <p>Dolor eu varius. Morbi fermentum velit nisl.</p>
                </li>
                <li class="benefits__item">
                    <img src="${pathTo('assets/images/footer/coins.png')}" alt="" aria-hidden="true" width="60" height="60">
                    <p>Malesuada fames ac ante ipsum primis in faucibus.</p>
                </li>
                <li class="benefits__item">
                    <img src="${pathTo('assets/images/footer/education.png')}" alt="" aria-hidden="true" width="60" height="60">
    ...
    <section class="footer__content">
        <div class="footer__first-container">
            <div class="footer__links">
                <div class="footer__block">
                    <h3 class="footer__title"><a href="${pathTo('html/about.html')}">About Us</a></h3>
                    <ul>
        ...
        <div class="footer__second-container">
            <div class="footer__block">
                <h3 class="footer__title"><a href="${pathTo('html/contact.html')}">Contact Us</a></h3>
                ...
                <ul class="contacts">
                    <li>
                        <a href="tel:+632366322">
                            <img src="${pathTo('assets/images/footer/phone-icon.svg')}" alt="Phone Icon">
                            <span>Phone: (+63) 236 6322</span>
                        </a>
                    </li>
                    <li>
                        <a href="mailto:public@news.com">
                            <img src="${pathTo('assets/images/footer/mail-icon.svg')}" alt="Mail Icon">
                            <span>public@news.com</span>
                        </a>
                    </li>
                    <li>
                        <img src="${pathTo('assets/images/footer/clock-icon.svg')}" alt="Clock Icon">
                        <p>Mon–Fri: 10am–6pm<br>Sat–Sun: 10am–6pm</p>
                    </li>
                    <li>
                        <img src="${pathTo('assets/images/footer/location-icon.svg')}" alt="Location Icon">
